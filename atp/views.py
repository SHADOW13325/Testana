...
def generate_test():
    ...
    if test_id == "obj":
        ...
        return render_template(
            ...
            question7=question_list[6],
            question8=question_list[7],
            question9=question_list[8],
            question10=question_list[9]
            #question11=question_list[10],
            #question12=question_list[11],
            #question13=question_list[12],
            #question14=question_list[13],
            #question15=question_list[14],
        )
    elif test_id == "subj":
...
def output():
    ...
    if global_test_id[0] == "obj":
        ...
        user_ans.append(str(request.form["answer6"]).strip().upper())
        user_ans.append(str(request.form["answer7"]).strip().upper())
        user_ans.append(str(request.form["answer8"]).strip().upper())
        user_ans.append(str(request.form["answer9"]).strip().upper())
        user_ans.append(str(request.form["answer10"]).strip().upper())
        # user_ans.append(str(request.form["answer11"]).strip().upper())
        # user_ans.append(str(request.form["answer12"]).strip().upper())
        # user_ans.append(str(request.form["answer13"]).strip().upper())
        # user_ans.append(str(request.form["answer14"]).strip().upper())
        # user_ans.append(str(request.form["answer15"]).strip().upper())
